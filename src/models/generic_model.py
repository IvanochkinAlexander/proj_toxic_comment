...
class GenericModel:
    ...
    def __init__(self, **kwargs):
        ...
        if 'use_neptune' in kwargs: self.use_neptune = kwargs['use_neptune']
    ...
    def evaluate(self, X_val, y_val, model):
        ...
        try:
            ...
            aucs = roc_auc_score(y_val, y_pred, average=None)
        except:
            logloss = 0.001
            auc = 0.99999
            aucs = [1,1,1,1,1,1]
        aucs_message = 'ROC AUCs: {}'.format(str(aucs))
        send_to_telegram(aucs_message)
        time.sleep(2)
